#
# functionality: class for creating azure_risk_level.service systemd service
# Author:  Dlo Bagari
...
class CreateService:
    ...
    def _create_service(self, name):
        service = """
[Unit]
Description= Run azure risk level manager service
Requires=azure_user.service
After=azure_user.service

[Service]
Restart=on-failure
RestartSec=5s
ExecStart={}/scripts/azure_risk_level_manager.sh run -c {}
