...
class RiskLevelConsumer:
    ...
    def _build_consumer(self):
        ...
        settings = {
                    ...
                    'group.id': self._settings['risk_level_consumer_group'] + "sjtipkiojkhiihlpjjyjkjyts",
                    'client.id': 'client-1',
    ...
    def subscribe(self, topic=None):
        ...
        """
        if topic is None:
            topic = self._settings["risk_level_topic_name"]
        ...
        try:
            while True:
                ...
                if msg is None:
                    ...
                    yield ConstValues.ERROR_CODE_ONE, 'Error occurred: {0}'.format(msg.error().str()), {}
