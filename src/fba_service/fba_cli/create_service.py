#
# functionality: class for creating fba.service systemd service
# Author:  Dlo Bagari
...
class CreateService:
    ...
    def _create_service(self, name):
        service = """
[Unit]
Description= run FBA service
Requires=kafka.service azure_event.service
After=kafka.service  azure_event.service

[Service]
Restart=on-failure
RestartSec=5s
ExecStart={}/scripts/fba_service.sh run -c {}
